...
//component
const SingUpView = () => {
  const [singupData, setData] = useState({
    username: "",
    email: "",
    password: "",
    terms: false
  ...
  const { username, email, password, terms } = singupData;
  return (
    <Fragment>
      <Header>
          ...
          <Row className="justify-content-center align-items-center  pt-2 pb-2">
            <Col xs={12} md={6}>
              <p style={{ color: "#B8C5D3" }}>
                ...
                <br />
                <b>
                  <strong>one month for free</strong>
                </b>
              </p>
