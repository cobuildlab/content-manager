...
const ForgotPasswordView = () => {
  ...
  const [forgotPasswordData, setData] = useState({
    email: "",
    codevalidation: "",
    password: "",
    passwordConfirm: ""
  ...
  const onChangeInput = e => {
    ...
    setData({ ...forgotPasswordData, [name]: value });
  };
  ...
  switch (stepForm.step) {
    ...
    case 2:
      content = (
        <CodeValidationForgotPasswordForm
          value={codevalidation}
          onChange={onChangeInput}
          onClick={onChangeStepForm}
          onSubmit={onSubmitCodeVerification}
        />
      );
      break;
    case 3:
      content = (
        <NewPasswordForgotPasswordForm
