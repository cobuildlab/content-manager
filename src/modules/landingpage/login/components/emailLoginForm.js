...
const EmailLoginForm = ({value, onChange, onClick})  =>{
  ...
  return(
    <Fragment>
      <p  style={{color: '#B8C5D3'}}><b><strong>with your email address</strong></b></p>
      <Form>
        <Row>
          <Col xs='8' sm='8'>
            <FormGroup>
            ...
            <FormGroup>
              <Button onClick={()=>{onClick(2);}} className='pl-3 pr-3 pt-2 pb-2' style={{backgroundColor: '#B8C5D3', border: 'none'}}><span><b>NEXT</b></span></Button>
            </FormGroup>
          </Col>
        </Row>
      </Form>
